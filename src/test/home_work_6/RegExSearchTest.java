...
public class RegExSearchTest {
    ...
    @Test
    public void search2() {
        Assertions.assertEquals(0, new RegExSearch().search("Мама мыла раму.", "мыл"));
    }

    @DisplayName("Поиск при разном регистре.")
    @Test
    public void search3() {
        Assertions.assertEquals(1, new RegExSearch().search("Мыл МЫЛ мыл.", "мыл"));
    }

    @DisplayName("Поиск слова с запятой после слова.")
    @Test
    public void search4() {
        Assertions.assertEquals(1, new RegExSearch().search("привет, как дела!", "привет"));
    }

    @DisplayName("Поиск слова с восклицательным знаком после слова.")
    @Test
    public void search5() {
        Assertions.assertEquals(1, new RegExSearch().search("привет, как дела!", "дела"));
    }

    @DisplayName("Поиск двух слепленных слов.")
    @Test
    public void search6() {
        Assertions.assertEquals(1, new RegExSearch().search("привет,какдела!", "какдела"));
    }

    @DisplayName("Поиск слова с \";\" после слова.")
    @Test
    public void search7() {
        Assertions.assertEquals(1, new RegExSearch().search("привет;какдела!", "привет"));
    }
    ...
    @Test
    public void search9() {
        Assertions.assertEquals(1, new RegExSearch().search("привет, пока", "привет"));
    }

    @DisplayName("Поиск слова в конце строки.")
    @Test
    public void search10() {
        Assertions.assertEquals(1, new RegExSearch().search("привет, пока", "пока"));
    }

    @DisplayName("Поиск слова, за которым следуют 2 символа.")
    @Test
    public void search11() {
        Assertions.assertEquals(1, new RegExSearch().search("как дела!.Что делаешь?", "дела"));
    }

    @DisplayName("Поиск слова, перед которым следуют 2 символа.")
    @Test
    public void search12() {
        Assertions.assertEquals(1, new RegExSearch().search("как дела!.Что делаешь?", "Что"));
    }
